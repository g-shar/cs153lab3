...
80100b5e:	e8 fd 5c 00 00       	call   80106860 <allocuvm>
...
80100b70:	e8 2b 5e 00 00       	call   801069a0 <freevm>
  return -1;
...
80100b7f:	e8 fc 1f 00 00       	call   80102b80 <end_op>
    cprintf("exec: fail\n");
80100b84:	c7 04 24 81 6e 10 80 	movl   $0x80106e81,(%esp)
...
80100b9a:	2d 00 20 00 00       	sub    $0x2000,%eax
80100b9f:	89 44 24 04          	mov    %eax,0x4(%esp)
80100ba3:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
80100ba9:	89 04 24             	mov    %eax,(%esp)
80100bac:	e8 1f 5f 00 00       	call   80106ad0 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
80100bb1:	8b 45 0c             	mov    0xc(%ebp),%eax
80100bb4:	8b 00                	mov    (%eax),%eax
80100bb6:	85 c0                	test   %eax,%eax
80100bb8:	0f 84 6a 01 00 00    	je     80100d28 <exec+0x388>
80100bbe:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80100bc1:	31 d2                	xor    %edx,%edx
  sp = KERNBASE;
80100bc3:	bb 00 00 00 80       	mov    $0x80000000,%ebx
80100bc8:	8d 71 04             	lea    0x4(%ecx),%esi
  for(argc = 0; argv[argc]; argc++) {
80100bcb:	89 cf                	mov    %ecx,%edi
80100bcd:	89 d1                	mov    %edx,%ecx
80100bcf:	89 f2                	mov    %esi,%edx
80100bd1:	89 fe                	mov    %edi,%esi
80100bd3:	89 cf                	mov    %ecx,%edi
80100bd5:	eb 09                	jmp    80100be0 <exec+0x240>
80100bd7:	90                   	nop
...
80100be9:	e8 c2 38 00 00       	call   801044b0 <strlen>
...
80100bfa:	e8 b1 38 00 00       	call   801044b0 <strlen>
...
80100cd9:	e8 92 37 00 00       	call   80104470 <safestrcpy>
  sz = PGROUNDUP(sz);
...
80100cea:	8b 77 08             	mov    0x8(%edi),%esi
  curproc->stack_sz = sp;
80100ced:	89 5f 04             	mov    %ebx,0x4(%edi)
  sz = PGROUNDUP(sz);
80100cf0:	05 ff 0f 00 00       	add    $0xfff,%eax
80100cf5:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80100cfa:	89 07                	mov    %eax,(%edi)
  curproc->tf->eip = elf.entry;  // main
80100cfc:	8b 47 1c             	mov    0x1c(%edi),%eax
  curproc->pgdir = pgdir;
80100cff:	89 57 08             	mov    %edx,0x8(%edi)
  curproc->tf->eip = elf.entry;  // main
80100d02:	8b 95 3c ff ff ff    	mov    -0xc4(%ebp),%edx
80100d08:	89 50 38             	mov    %edx,0x38(%eax)
  curproc->tf->esp = sp;
80100d0b:	8b 47 1c             	mov    0x1c(%edi),%eax
80100d0e:	89 58 44             	mov    %ebx,0x44(%eax)
  switchuvm(curproc);
80100d11:	89 3c 24             	mov    %edi,(%esp)
80100d14:	e8 e7 58 00 00       	call   80106600 <switchuvm>
  freevm(oldpgdir);
80100d19:	89 34 24             	mov    %esi,(%esp)
80100d1c:	e8 7f 5c 00 00       	call   801069a0 <freevm>
  return 0;
80100d21:	31 c0                	xor    %eax,%eax
80100d23:	e9 ea fc ff ff       	jmp    80100a12 <exec+0x72>
  sp = KERNBASE;
80100d28:	bb 00 00 00 80       	mov    $0x80000000,%ebx
  for(argc = 0; argv[argc]; argc++) {
80100d2d:	31 d2                	xor    %edx,%edx
80100d2f:	8d 8d 58 ff ff ff    	lea    -0xa8(%ebp),%ecx
80100d35:	e9 0c ff ff ff       	jmp    80100c46 <exec+0x2a6>
...
80100d46:	c7 44 24 04 8d 6e 10 	movl   $0x80106e8d,0x4(%esp)
80100d4d:	80 
80100d4e:	c7 04 24 c0 ff 10 80 	movl   $0x8010ffc0,(%esp)
80100d55:	e8 06 33 00 00       	call   80104060 <initlock>
}
80100d5a:	c9                   	leave  
80100d5b:	c3                   	ret    
...
80100d73:	e8 d8 33 00 00       	call   80104150 <acquire>
...
80100d99:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      release(&ftable.lock);
80100da0:	e8 9b 34 00 00       	call   80104240 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100db7:	e8 84 34 00 00       	call   80104240 <release>
}
...
80100de1:	e8 6a 33 00 00       	call   80104150 <acquire>
  if(f->ref < 1)
...
80100dfa:	e8 41 34 00 00       	call   80104240 <release>
  return f;
}
...
80100e06:	c3                   	ret    
    panic("filedup");
80100e07:	c7 04 24 94 6e 10 80 	movl   $0x80106e94,(%esp)
...
80100e33:	e8 18 33 00 00       	call   80104150 <acquire>
  if(f->ref < 1)
...
80100e5a:	5d                   	pop    %ebp
    release(&ftable.lock);
80100e5b:	e9 e0 33 00 00       	jmp    80104240 <release>
  ff = *f;
...
80100e7c:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100e7f:	e8 bc 33 00 00       	call   80104240 <release>
  if(ff.type == FD_PIPE)
...
80100ec7:	e9 b4 1c 00 00       	jmp    80102b80 <end_op>
    panic("fileclose");
80100ecc:	c7 04 24 9c 6e 10 80 	movl   $0x80106e9c,(%esp)
...
80100fb5:	eb d8                	jmp    80100f8f <fileread+0x5f>
  panic("fileread");
80100fb7:	c7 04 24 a6 6e 10 80 	movl   $0x80106ea6,(%esp)
...
801010cc:	e9 1f 22 00 00       	jmp    801032f0 <pipewrite>
        panic("short filewrite");
801010d1:	c7 04 24 af 6e 10 80 	movl   $0x80106eaf,(%esp)
801010d8:	e8 83 f2 ff ff       	call   80100360 <panic>
  panic("filewrite");
801010dd:	c7 04 24 b5 6e 10 80 	movl   $0x80106eb5,(%esp)
...
801011e8:	e8 a3 30 00 00       	call   80104290 <memset>
  log_write(bp);
...
80101229:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
8010122c:	e8 1f 2f 00 00       	call   80104150 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
80101266:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
80101269:	e8 d2 2f 00 00       	call   80104240 <release>
  ip->ref = 1;
  ip->valid = 0;
  release(&icache.lock);
...
801012ae:	e8 8d 2f 00 00       	call   80104240 <release>
}
...
801012bd:	c7 04 24 d5 6e 10 80 	movl   $0x80106ed5,(%esp)
...
80101375:	eb 93                	jmp    8010130a <bmap+0x3a>
  panic("bmap: out of range");
80101377:	c7 04 24 e5 6e 10 80 	movl   $0x80106ee5,(%esp)
...
801013c2:	e8 69 2f 00 00       	call   80104330 <memmove>
  brelse(bp);
...
80101459:	c7 04 24 f8 6e 10 80 	movl   $0x80106ef8,(%esp)
...
8010147c:	c7 44 24 04 0b 6f 10 	movl   $0x80106f0b,0x4(%esp)
80101483:	80 
80101484:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
8010148b:	e8 d0 2b 00 00       	call   80104060 <initlock>
    initsleeplock(&icache.inode[i].lock, "inode");
80101490:	89 1c 24             	mov    %ebx,(%esp)
80101493:	81 c3 90 00 00 00    	add    $0x90,%ebx
80101499:	c7 44 24 04 12 6f 10 	movl   $0x80106f12,0x4(%esp)
801014a0:	80 
801014a1:	e8 aa 2a 00 00       	call   80103f50 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801014c6:	c7 04 24 78 6f 10 80 	movl   $0x80106f78,(%esp)
...
801015a9:	e8 e2 2c 00 00       	call   80104290 <memset>
      dip->type = type;
...
801015e1:	c7 04 24 18 6f 10 80 	movl   $0x80106f18,(%esp)
...
8010165f:	00 
80101660:	e8 cb 2c 00 00       	call   80104330 <memmove>
  log_write(bp);
...
80101691:	e8 ba 2a 00 00       	call   80104150 <acquire>
  ip->ref++;
80101696:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
8010169a:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801016a1:	e8 9a 2b 00 00       	call   80104240 <release>
}
...
801016d4:	e8 b7 28 00 00       	call   80103f90 <acquiresleep>
  if(ip->valid == 0){
...
8010174b:	e8 e0 2b 00 00       	call   80104330 <memmove>
    brelse(bp);
...
80101764:	0f 85 76 ff ff ff    	jne    801016e0 <ilock+0x30>
      panic("ilock: no type");
8010176a:	c7 04 24 30 6f 10 80 	movl   $0x80106f30,(%esp)
80101771:	e8 ea eb ff ff       	call   80100360 <panic>
    panic("ilock");
80101776:	c7 04 24 2a 6f 10 80 	movl   $0x80106f2a,(%esp)
...
801017a5:	e8 86 28 00 00       	call   80104030 <holdingsleep>
...
801017bd:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
801017be:	e9 2d 28 00 00       	jmp    80103ff0 <releasesleep>
    panic("iunlock");
801017c3:	c7 04 24 3f 6f 10 80 	movl   $0x80106f3f,(%esp)
...
801017e2:	e8 a9 27 00 00       	call   80103f90 <acquiresleep>
...
801017f8:	e8 f3 27 00 00       	call   80103ff0 <releasesleep>
  acquire(&icache.lock);
801017fd:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101804:	e8 47 29 00 00       	call   80104150 <acquire>
  ip->ref--;
...
8010181a:	5d                   	pop    %ebp
  release(&icache.lock);
8010181b:	e9 20 2a 00 00       	jmp    80104240 <release>
    acquire(&icache.lock);
80101820:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101827:	e8 24 29 00 00       	call   80104150 <acquire>
    int r = ip->ref;
8010182c:	8b 5e 08             	mov    0x8(%esi),%ebx
    release(&icache.lock);
8010182f:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101836:	e8 05 2a 00 00       	call   80104240 <release>
    if(r == 1){
...
80101a08:	e8 23 29 00 00       	call   80104330 <memmove>
    brelse(bp);
...
80101b04:	e8 27 28 00 00       	call   80104330 <memmove>
    log_write(bp);
...
80101bab:	e8 00 28 00 00       	call   801043b0 <strncmp>
}
80101bb0:	c9                   	leave  
80101bb1:	c3                   	ret    
...
80101c29:	e8 82 27 00 00       	call   801043b0 <strncmp>
      continue;
...
80101c61:	c3                   	ret    
      panic("dirlookup read");
80101c62:	c7 04 24 59 6f 10 80 	movl   $0x80106f59,(%esp)
80101c69:	e8 f2 e6 ff ff       	call   80100360 <panic>
    panic("dirlookup not DIR");
80101c6e:	c7 04 24 47 6f 10 80 	movl   $0x80106f47,(%esp)
...
80101ca8:	e8 a3 24 00 00       	call   80104150 <acquire>
  ip->ref++;
80101cad:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101cb1:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101cb8:	e8 83 25 00 00       	call   80104240 <release>
...
80101d1b:	e8 10 26 00 00       	call   80104330 <memmove>
    path++;
...
80101da9:	e8 82 25 00 00       	call   80104330 <memmove>
    name[len] = 0;
...
80101ea3:	e8 78 25 00 00       	call   80104420 <strncpy>
  de.inum = inum;
...
80101ee3:	eb e9                	jmp    80101ece <dirlink+0xae>
      panic("dirlink read");
80101ee5:	c7 04 24 68 6f 10 80 	movl   $0x80106f68,(%esp)
...
80101fdf:	c7 04 24 d4 6f 10 80 	movl   $0x80106fd4,(%esp)
80101fe6:	e8 75 e3 ff ff       	call   80100360 <panic>
    panic("idestart");
80101feb:	c7 04 24 cb 6f 10 80 	movl   $0x80106fcb,(%esp)
...
80102006:	c7 44 24 04 e6 6f 10 	movl   $0x80106fe6,0x4(%esp)
8010200d:	80 
8010200e:	c7 04 24 80 a5 10 80 	movl   $0x8010a580,(%esp)
80102015:	e8 46 20 00 00       	call   80104060 <initlock>
...
80102090:	e8 bb 20 00 00       	call   80104150 <acquire>
...
801020bc:	e8 df 1c 00 00       	call   80103da0 <wakeup>
...
801020d6:	e8 65 21 00 00       	call   80104240 <release>
...
80102130:	e8 fb 1e 00 00       	call   80104030 <holdingsleep>
...
80102166:	e8 e5 1f 00 00       	call   80104150 <acquire>
...
801021c5:	5d                   	pop    %ebp
  release(&idelock);
801021c6:	e9 75 20 00 00       	jmp    80104240 <release>
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
...
801021d9:	eb bb                	jmp    80102196 <iderw+0x76>
    panic("iderw: buf not locked");
801021db:	c7 04 24 ea 6f 10 80 	movl   $0x80106fea,(%esp)
801021e2:	e8 79 e1 ff ff       	call   80100360 <panic>
    panic("iderw: ide disk 1 not present");
801021e7:	c7 04 24 15 70 10 80 	movl   $0x80107015,(%esp)
801021ee:	e8 6d e1 ff ff       	call   80100360 <panic>
    panic("iderw: nothing to do");
801021f3:	c7 04 24 00 70 10 80 	movl   $0x80107000,(%esp)
...
80102248:	c7 04 24 34 70 10 80 	movl   $0x80107034,(%esp)
...
8010232a:	e8 61 1f 00 00       	call   80104290 <memset>
...
80102363:	5d                   	pop    %ebp
    release(&kmem.lock);
80102364:	e9 d7 1e 00 00       	jmp    80104240 <release>
80102369:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    acquire(&kmem.lock);
80102370:	c7 04 24 40 26 11 80 	movl   $0x80112640,(%esp)
80102377:	e8 d4 1d 00 00       	call   80104150 <acquire>
8010237c:	eb bb                	jmp    80102339 <kfree+0x49>
    panic("kfree");
8010237e:	c7 04 24 66 70 10 80 	movl   $0x80107066,(%esp)
...
801023eb:	c7 44 24 04 6c 70 10 	movl   $0x8010706c,0x4(%esp)
801023f2:	80 
801023f3:	c7 04 24 40 26 11 80 	movl   $0x80112640,(%esp)
801023fa:	e8 61 1c 00 00       	call   80104060 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801024cd:	e8 6e 1d 00 00       	call   80104240 <release>
  return (char*)r;
}
...
801024e7:	e8 64 1c 00 00       	call   80104150 <acquire>
...
80102534:	0f b6 81 a0 71 10 80 	movzbl -0x7fef8e60(%ecx),%eax
...
80102568:	0f b6 91 a0 71 10 80 	movzbl -0x7fef8e60(%ecx),%edx
  shift ^= togglecode[data];
8010256f:	0f b6 81 a0 70 10 80 	movzbl -0x7fef8f60(%ecx),%eax
  shift |= shiftcode[data];
...
8010257f:	8b 04 85 80 70 10 80 	mov    -0x7fef8f80(,%eax,4),%eax
  shift ^= togglecode[data];
...
8010289c:	e8 3f 1a 00 00       	call   801042e0 <memcmp>
...
801029c7:	e8 64 19 00 00       	call   80104330 <memmove>
...
80102a7b:	c7 44 24 04 a0 72 10 	movl   $0x801072a0,0x4(%esp)
80102a82:	80 
80102a83:	c7 04 24 80 26 11 80 	movl   $0x80112680,(%esp)
80102a8a:	e8 d1 15 00 00       	call   80104060 <initlock>
  readsb(dev, &sb);
...
80102b1d:	e8 2e 16 00 00       	call   80104150 <acquire>
...
80102b65:	a3 bc 26 11 80       	mov    %eax,0x801126bc
      release(&log.lock);
80102b6a:	e8 d1 16 00 00       	call   80104240 <release>
      break;
    }
  }
}
...
80102b90:	e8 bb 15 00 00       	call   80104150 <acquire>
  log.outstanding -= 1;
...
80102bc8:	00 00 00 
  release(&log.lock);
80102bcb:	e8 70 16 00 00       	call   80104240 <release>
  if (log.lh.n > 0) {
...
80102c2f:	e8 fc 16 00 00       	call   80104330 <memmove>
...
80102ca2:	c3                   	ret    
    panic("log.committing");
80102ca3:	c7 04 24 a4 72 10 80 	movl   $0x801072a4,(%esp)
...
80102ced:	e8 5e 14 00 00       	call   80104150 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102d3e:	5d                   	pop    %ebp
  release(&log.lock);
80102d3f:	e9 fc 14 00 00       	jmp    80104240 <release>
...
80102d5d:	8d 76 00             	lea    0x0(%esi),%esi
    panic("too big a transaction");
80102d60:	c7 04 24 b3 72 10 80 	movl   $0x801072b3,(%esp)
80102d67:	e8 f4 d5 ff ff       	call   80100360 <panic>
    panic("log_write outside of trans");
80102d6c:	c7 04 24 c9 72 10 80 	movl   $0x801072c9,(%esp)
...
80102d97:	c7 04 24 e4 72 10 80 	movl   $0x801072e4,(%esp)
80102d9e:	89 44 24 04          	mov    %eax,0x4(%esp)
80102da2:	e8 a9 d8 ff ff       	call   80100650 <cprintf>
  idtinit();       // load idt register
80102da7:	e8 74 27 00 00       	call   80105520 <idtinit>
...
80102dd3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102dd6:	e8 05 38 00 00       	call   801065e0 <switchkvm>
  seginit();
80102ddb:	e8 c0 36 00 00       	call   801064a0 <seginit>
  lapicinit();
...
80102e13:	e8 98 3c 00 00       	call   80106ab0 <kvmalloc>
...
80102e25:	e8 76 36 00 00       	call   801064a0 <seginit>
  picinit();       // disable pic
...
80102e3a:	e8 01 2a 00 00       	call   80105840 <uartinit>
80102e3f:	90                   	nop
  pinit();         // process table
80102e40:	e8 9b 07 00 00       	call   801035e0 <pinit>
  shminit();       // shared memory
80102e45:	e8 26 3f 00 00       	call   80106d70 <shminit>
  tvinit();        // trap vectors
80102e4a:	e8 31 26 00 00       	call   80105480 <tvinit>
80102e4f:	90                   	nop
  binit();         // buffer cache
...
80102e76:	e8 b5 14 00 00       	call   80104330 <memmove>
  for(c = cpus; c < cpus+ncpu; c++){
...
80102f3f:	00 
80102f40:	c7 44 24 04 f8 72 10 	movl   $0x801072f8,0x4(%esp)
80102f47:	80 
80102f48:	89 34 24             	mov    %esi,(%esp)
80102f4b:	e8 90 13 00 00       	call   801042e0 <memcmp>
...
80102ffa:	00 
80102ffb:	c7 44 24 04 fd 72 10 	movl   $0x801072fd,0x4(%esp)
80103002:	80 
80103003:	89 04 24             	mov    %eax,(%esp)
  conf = (struct mpconf*) P2V((uint) mp->physaddr);
80103006:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80103009:	e8 d2 12 00 00       	call   801042e0 <memcmp>
...
8010308c:	ff 24 8d 3c 73 10 80 	jmp    *-0x7fef8cc4(,%ecx,4)
80103093:	90                   	nop
...
80103117:	0f 85 c5 fe ff ff    	jne    80102fe2 <mpinit+0x52>
    panic("Expect to run on an SMP");
8010311d:	c7 04 24 02 73 10 80 	movl   $0x80107302,(%esp)
...
80103138:	eb e3                	jmp    8010311d <mpinit+0x18d>
    panic("Didn't find a suitable machine");
8010313a:	c7 04 24 1c 73 10 80 	movl   $0x8010731c,(%esp)
...
801031df:	c7 44 24 04 50 73 10 	movl   $0x80107350,0x4(%esp)
801031e6:	80 
801031e7:	e8 74 0e 00 00       	call   80104060 <initlock>
  (*f0)->type = FD_PIPE;
...
80103271:	e8 da 0e 00 00       	call   80104150 <acquire>
  if(writable){
...
8010328d:	e8 0e 0b 00 00       	call   80103da0 <wakeup>
  } else {
    p->readopen = 0;
    wakeup(&p->nwrite);
  }
...
801032ae:	5d                   	pop    %ebp
    release(&p->lock);
801032af:	e9 8c 0f 00 00       	jmp    80104240 <release>
...
801032ff:	e8 4c 0e 00 00       	call   80104150 <acquire>
  for(i = 0; i < n; i++){
...
8010334f:	e8 4c 0a 00 00       	call   80103da0 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
...
80103382:	e8 b9 0e 00 00       	call   80104240 <release>
        return -1;
...
801033ca:	e8 d1 09 00 00       	call   80103da0 <wakeup>
  release(&p->lock);
801033cf:	89 1c 24             	mov    %ebx,(%esp)
801033d2:	e8 69 0e 00 00       	call   80104240 <release>
  return n;
...
801033f2:	e8 59 0d 00 00       	call   80104150 <acquire>
...
8010344b:	e8 f0 0d 00 00       	call   80104240 <release>
...
801034a5:	e8 f6 08 00 00       	call   80103da0 <wakeup>
  release(&p->lock);
801034aa:	89 34 24             	mov    %esi,(%esp)
801034ad:	e8 8e 0d 00 00       	call   80104240 <release>
}
...
801034d3:	e8 78 0c 00 00       	call   80104150 <acquire>
...
8010350e:	89 43 14             	mov    %eax,0x14(%ebx)
  release(&ptable.lock);
80103511:	e8 2a 0d 00 00       	call   80104240 <release>
...
8010352d:	89 53 1c             	mov    %edx,0x1c(%ebx)
  *(uint*)sp = (uint)trapret;
80103530:	c7 40 14 75 54 10 80 	movl   $0x80105475,0x14(%eax)
...
8010354a:	89 43 20             	mov    %eax,0x20(%ebx)
  memset(p->context, 0, sizeof *p->context);
8010354d:	e8 3e 0d 00 00       	call   80104290 <memset>
...
8010356f:	e8 cc 0c 00 00       	call   80104240 <release>
}
...
8010359d:	e8 9e 0c 00 00       	call   80104240 <release>
...
801035e6:	c7 44 24 04 55 73 10 	movl   $0x80107355,0x4(%esp)
801035ed:	80 
801035ee:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801035f5:	e8 66 0a 00 00       	call   80104060 <initlock>
}
801035fa:	c9                   	leave  
801035fb:	c3                   	ret    
...
8010365a:	c7 04 24 5c 73 10 80 	movl   $0x8010735c,(%esp)
80103661:	e8 fa cc ff ff       	call   80100360 <panic>
    panic("mycpu called with interrupts enabled\n");
80103666:	c7 04 24 4c 74 10 80 	movl   $0x8010744c,(%esp)
...
801036b1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801036b7:	e8 14 0b 00 00       	call   801041d0 <popcli>
}
...
801036e3:	e8 38 33 00 00       	call   80106a20 <setupkvm>
...
80103705:	80 
80103706:	e8 05 30 00 00       	call   80106710 <inituvm>
  p->sz = PGSIZE;
...
80103727:	e8 64 0b 00 00       	call   80104290 <memset>
...
80103782:	00 
80103783:	c7 44 24 04 85 73 10 	movl   $0x80107385,0x4(%esp)
8010378a:	80 
8010378b:	89 04 24             	mov    %eax,(%esp)
8010378e:	e8 dd 0c 00 00       	call   80104470 <safestrcpy>
  p->cwd = namei("/");
80103793:	c7 04 24 8e 73 10 80 	movl   $0x8010738e,(%esp)
...
801037c7:	c7 04 24 6c 73 10 80 	movl   $0x8010736c,(%esp)
...
80103817:	e8 e4 2d 00 00       	call   80106600 <switchuvm>
  return 0;
...
8010383a:	e8 41 31 00 00       	call   80106980 <deallocuvm>
...
80103856:	83 ec 2c             	sub    $0x2c,%esp
  struct proc *curproc = myproc();
...
8010386c:	0f 84 d1 00 00 00    	je     80103943 <fork+0xf3>
  cprintf("fork called for %s\n", curproc->name);
80103872:	8d 43 70             	lea    0x70(%ebx),%eax
80103875:	89 44 24 04          	mov    %eax,0x4(%esp)
80103879:	c7 04 24 90 73 10 80 	movl   $0x80107390,(%esp)
80103880:	89 45 e0             	mov    %eax,-0x20(%ebp)
80103883:	e8 c8 cd ff ff       	call   80100650 <cprintf>
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz)) == 0){
80103888:	8b 03                	mov    (%ebx),%eax
8010388a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010388e:	8b 43 08             	mov    0x8(%ebx),%eax
80103891:	89 04 24             	mov    %eax,(%esp)
80103894:	e8 67 32 00 00       	call   80106b00 <copyuvm>
80103899:	85 c0                	test   %eax,%eax
8010389b:	89 47 08             	mov    %eax,0x8(%edi)
8010389e:	0f 84 a6 00 00 00    	je     8010394a <fork+0xfa>
  np->sz = curproc->sz;
801038a4:	8b 03                	mov    (%ebx),%eax
  *np->tf = *curproc->tf;
801038a6:	b9 13 00 00 00       	mov    $0x13,%ecx
  np->sz = curproc->sz;
801038ab:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801038ae:	89 02                	mov    %eax,(%edx)
  np->stack_sz = curproc->stack_sz;
801038b0:	8b 43 04             	mov    0x4(%ebx),%eax
  *np->tf = *curproc->tf;
801038b3:	8b 7a 1c             	mov    0x1c(%edx),%edi
  np->parent = curproc;
801038b6:	89 5a 18             	mov    %ebx,0x18(%edx)
  np->stack_sz = curproc->stack_sz;
801038b9:	89 42 04             	mov    %eax,0x4(%edx)
  *np->tf = *curproc->tf;
801038bc:	8b 73 1c             	mov    0x1c(%ebx),%esi
801038bf:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for(i = 0; i < NOFILE; i++)
801038c1:	31 f6                	xor    %esi,%esi
801038c3:	89 d7                	mov    %edx,%edi
  np->tf->eax = 0;
801038c5:	8b 42 1c             	mov    0x1c(%edx),%eax
801038c8:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
801038cf:	90                   	nop
    if(curproc->ofile[i])
801038d0:	8b 44 b3 2c          	mov    0x2c(%ebx,%esi,4),%eax
801038d4:	85 c0                	test   %eax,%eax
801038d6:	74 0c                	je     801038e4 <fork+0x94>
      np->ofile[i] = filedup(curproc->ofile[i]);
801038d8:	89 04 24             	mov    %eax,(%esp)
801038db:	e8 f0 d4 ff ff       	call   80100dd0 <filedup>
801038e0:	89 44 b7 2c          	mov    %eax,0x2c(%edi,%esi,4)
  for(i = 0; i < NOFILE; i++)
801038e4:	83 c6 01             	add    $0x1,%esi
801038e7:	83 fe 10             	cmp    $0x10,%esi
801038ea:	75 e4                	jne    801038d0 <fork+0x80>
  np->cwd = idup(curproc->cwd);
801038ec:	8b 43 6c             	mov    0x6c(%ebx),%eax
801038ef:	89 04 24             	mov    %eax,(%esp)
801038f2:	e8 89 dd ff ff       	call   80101680 <idup>
801038f7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
801038fa:	89 47 6c             	mov    %eax,0x6c(%edi)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
801038fd:	8b 45 e0             	mov    -0x20(%ebp),%eax
80103900:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80103907:	00 
80103908:	89 44 24 04          	mov    %eax,0x4(%esp)
8010390c:	8d 47 70             	lea    0x70(%edi),%eax
8010390f:	89 04 24             	mov    %eax,(%esp)
80103912:	e8 59 0b 00 00       	call   80104470 <safestrcpy>
  pid = np->pid;
80103917:	8b 5f 14             	mov    0x14(%edi),%ebx
  acquire(&ptable.lock);
8010391a:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103921:	e8 2a 08 00 00       	call   80104150 <acquire>
  np->state = RUNNABLE;
80103926:	c7 47 10 03 00 00 00 	movl   $0x3,0x10(%edi)
  release(&ptable.lock);
8010392d:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103934:	e8 07 09 00 00       	call   80104240 <release>
  return pid;
80103939:	89 d8                	mov    %ebx,%eax
}
8010393b:	83 c4 2c             	add    $0x2c,%esp
8010393e:	5b                   	pop    %ebx
8010393f:	5e                   	pop    %esi
80103940:	5f                   	pop    %edi
80103941:	5d                   	pop    %ebp
...
80103948:	eb f1                	jmp    8010393b <fork+0xeb>
    kfree(np->kstack);
8010394a:	8b 7d e4             	mov    -0x1c(%ebp),%edi
8010394d:	8b 47 0c             	mov    0xc(%edi),%eax
80103950:	89 04 24             	mov    %eax,(%esp)
80103953:	e8 98 e9 ff ff       	call   801022f0 <kfree>
    return -1;
80103958:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    np->kstack = 0;
8010395d:	c7 47 0c 00 00 00 00 	movl   $0x0,0xc(%edi)
    np->state = UNUSED;
80103964:	c7 47 10 00 00 00 00 	movl   $0x0,0x10(%edi)
    return -1;
8010396b:	eb ce                	jmp    8010393b <fork+0xeb>
...
80103976:	83 ec 1c             	sub    $0x1c,%esp
  struct cpu *c = mycpu();
80103979:	e8 82 fc ff ff       	call   80103600 <mycpu>
...
801039c2:	83 eb 80             	sub    $0xffffff80,%ebx
      switchuvm(p);
801039c5:	e8 36 2c 00 00       	call   80106600 <switchuvm>
...
801039db:	e8 eb 0a 00 00       	call   801044cb <swtch>
      switchkvm();
801039e0:	e8 fb 2b 00 00       	call   801065e0 <switchkvm>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103a7e:	c7 04 24 a4 73 10 80 	movl   $0x801073a4,(%esp)
80103a85:	e8 d6 c8 ff ff       	call   80100360 <panic>
    panic("sched interruptible");
80103a8a:	c7 04 24 d0 73 10 80 	movl   $0x801073d0,(%esp)
80103a91:	e8 ca c8 ff ff       	call   80100360 <panic>
    panic("sched running");
80103a96:	c7 04 24 c2 73 10 80 	movl   $0x801073c2,(%esp)
80103a9d:	e8 be c8 ff ff       	call   80100360 <panic>
    panic("sched locks");
80103aa2:	c7 04 24 b6 73 10 80 	movl   $0x801073b6,(%esp)
...
80103adb:	e8 40 d3 ff ff       	call   80100e20 <fileclose>
      curproc->ofile[fd] = 0;
...
80103ba6:	e8 65 fe ff ff       	call   80103a10 <sched>
  panic("zombie exit");
80103bab:	c7 04 24 f1 73 10 80 	movl   $0x801073f1,(%esp)
80103bb2:	e8 a9 c7 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103bb7:	c7 04 24 e4 73 10 80 	movl   $0x801073e4,(%esp)
...
80103c9e:	c7 04 24 03 74 10 80 	movl   $0x80107403,(%esp)
80103ca5:	e8 b6 c6 ff ff       	call   80100360 <panic>
    panic("sleep");
80103caa:	c7 04 24 fd 73 10 80 	movl   $0x801073fd,(%esp)
...
80103d2b:	eb ae                	jmp    80103cdb <wait+0x1b>
        kfree(p->kstack);
80103d2d:	8b 43 0c             	mov    0xc(%ebx),%eax
        pid = p->pid;
80103d30:	8b 73 14             	mov    0x14(%ebx),%esi
        kfree(p->kstack);
80103d33:	89 04 24             	mov    %eax,(%esp)
80103d36:	e8 b5 e5 ff ff       	call   801022f0 <kfree>
        freevm(p->pgdir);
80103d3b:	8b 43 08             	mov    0x8(%ebx),%eax
        p->kstack = 0;
80103d3e:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        freevm(p->pgdir);
...
80103e94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e98:	c7 04 24 9f 77 10 80 	movl   $0x8010779f,(%esp)
...
80103eba:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80103ebd:	ba 14 74 10 80       	mov    $0x80107414,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103ec2:	77 11                	ja     80103ed5 <procdump+0x55>
80103ec4:	8b 14 85 74 74 10 80 	mov    -0x7fef8b8c(,%eax,4),%edx
      state = "???";
80103ecb:	b8 14 74 10 80       	mov    $0x80107414,%eax
...
80103ee0:	c7 04 24 18 74 10 80 	movl   $0x80107418,(%esp)
...
80103f29:	c7 04 24 41 6e 10 80 	movl   $0x80106e41,(%esp)
...
80103f5a:	c7 44 24 04 8c 74 10 	movl   $0x8010748c,0x4(%esp)
80103f61:	80 
...
80103fc2:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80103fc8:	e8 d3 f6 ff ff       	call   801036a0 <myproc>
...
801040f5:	e8 06 f5 ff ff       	call   80103600 <mycpu>
...
80104182:	e8 79 f4 ff ff       	call   80103600 <mycpu>
...
801041ab:	e8 50 f4 ff ff       	call   80103600 <mycpu>
  if(holding(lk))
...
801041b7:	eb ac                	jmp    80104165 <acquire+0x15>
    panic("acquire");
801041b9:	c7 04 24 97 74 10 80 	movl   $0x80107497,(%esp)
...
801041db:	75 49                	jne    80104226 <popcli+0x56>
  ...
  if(--mycpu()->ncli < 0)
801041dd:	e8 1e f4 ff ff       	call   80103600 <mycpu>
...
801041f5:	e8 06 f4 ff ff       	call   80103600 <mycpu>
...
80104206:	66 90                	xchg   %ax,%ax
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104208:	e8 f3 f3 ff ff       	call   80103600 <mycpu>
...
80104219:	c3                   	ret    
    panic("popcli");
8010421a:	c7 04 24 b6 74 10 80 	movl   $0x801074b6,(%esp)
80104221:	e8 3a c1 ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
80104226:	c7 04 24 9f 74 10 80 	movl   $0x8010749f,(%esp)
...
801044ea:	e8 b1 f1 ff ff       	call   801036a0 <myproc>
  ...
  if((addr >= curproc->sz || addr+4 > curproc->sz) && !(addr < KERNBASE && addr + 4 < KERNBASE && addr >= curproc->stack_sz))
801044ef:	8b 10                	mov    (%eax),%edx
801044f1:	39 da                	cmp    %ebx,%edx
801044f3:	76 07                	jbe    801044fc <fetchint+0x1c>
801044f5:	8d 4b 04             	lea    0x4(%ebx),%ecx
801044f8:	39 ca                	cmp    %ecx,%edx
801044fa:	73 0d                	jae    80104509 <fetchint+0x29>
801044fc:	81 fb fb ff ff 7f    	cmp    $0x7ffffffb,%ebx
80104502:	77 14                	ja     80104518 <fetchint+0x38>
80104504:	3b 58 04             	cmp    0x4(%eax),%ebx
80104507:	72 0f                	jb     80104518 <fetchint+0x38>
    return -1;
  *ip = *(int*)(addr);
80104509:	8b 45 0c             	mov    0xc(%ebp),%eax
8010450c:	8b 13                	mov    (%ebx),%edx
8010450e:	89 10                	mov    %edx,(%eax)
  return 0;
80104510:	31 c0                	xor    %eax,%eax
}
80104512:	83 c4 04             	add    $0x4,%esp
80104515:	5b                   	pop    %ebx
80104516:	5d                   	pop    %ebp
80104517:	c3                   	ret    
    return -1;
80104518:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010451d:	eb f3                	jmp    80104512 <fetchint+0x32>
8010451f:	90                   	nop
...
8010452a:	e8 71 f1 ff ff       	call   801036a0 <myproc>
  ...
  if(addr >= curproc->sz && !(addr < KERNBASE && addr >= curproc->stack_sz))
8010452f:	39 18                	cmp    %ebx,(%eax)
80104531:	77 09                	ja     8010453c <fetchstr+0x1c>
80104533:	85 db                	test   %ebx,%ebx
80104535:	78 25                	js     8010455c <fetchstr+0x3c>
80104537:	3b 58 04             	cmp    0x4(%eax),%ebx
8010453a:	72 20                	jb     8010455c <fetchstr+0x3c>
    return -1;
  *pp = (char*)addr;
8010453c:	8b 4d 0c             	mov    0xc(%ebp),%ecx
8010453f:	89 da                	mov    %ebx,%edx
80104541:	89 19                	mov    %ebx,(%ecx)
  ep = (char*)curproc->sz;
80104543:	8b 00                	mov    (%eax),%eax
  for(s = *pp; s < ep; s++){
80104545:	39 c3                	cmp    %eax,%ebx
80104547:	73 13                	jae    8010455c <fetchstr+0x3c>
    if(*s == 0)
80104549:	80 3b 00             	cmpb   $0x0,(%ebx)
8010454c:	75 07                	jne    80104555 <fetchstr+0x35>
8010454e:	eb 18                	jmp    80104568 <fetchstr+0x48>
80104550:	80 3a 00             	cmpb   $0x0,(%edx)
80104553:	74 13                	je     80104568 <fetchstr+0x48>
  for(s = *pp; s < ep; s++){
80104555:	83 c2 01             	add    $0x1,%edx
80104558:	39 d0                	cmp    %edx,%eax
8010455a:	77 f4                	ja     80104550 <fetchstr+0x30>
      return s - *pp;
  }
  return -1;
}
...
80104593:	8b 40 1c             	mov    0x1c(%eax),%eax
...
801045d6:	78 38                	js     80104610 <argptr+0x60>
    return -1;
  if(size < 0 || (((uint)i >= curproc->sz || (uint)i+size > curproc->sz) && !((uint)i < KERNBASE && (uint)i+size < KERNBASE && (uint)i >= curproc->stack_sz)))
801045d8:	85 db                	test   %ebx,%ebx
801045da:	78 34                	js     80104610 <argptr+0x60>
801045dc:	8b 55 f4             	mov    -0xc(%ebp),%edx
801045df:	8b 06                	mov    (%esi),%eax
801045e1:	39 c2                	cmp    %eax,%edx
801045e3:	72 1b                	jb     80104600 <argptr+0x50>
801045e5:	85 d2                	test   %edx,%edx
801045e7:	78 27                	js     80104610 <argptr+0x60>
801045e9:	01 d3                	add    %edx,%ebx
801045eb:	78 23                	js     80104610 <argptr+0x60>
801045ed:	3b 56 04             	cmp    0x4(%esi),%edx
801045f0:	72 1e                	jb     80104610 <argptr+0x60>
    return -1;
  *pp = (char*)i;
801045f2:	8b 45 0c             	mov    0xc(%ebp),%eax
801045f5:	89 10                	mov    %edx,(%eax)
  return 0;
801045f7:	31 c0                	xor    %eax,%eax
}
801045f9:	83 c4 20             	add    $0x20,%esp
801045fc:	5b                   	pop    %ebx
801045fd:	5e                   	pop    %esi
801045fe:	5d                   	pop    %ebp
801045ff:	c3                   	ret    
  if(size < 0 || (((uint)i >= curproc->sz || (uint)i+size > curproc->sz) && !((uint)i < KERNBASE && (uint)i+size < KERNBASE && (uint)i >= curproc->stack_sz)))
80104600:	8d 0c 13             	lea    (%ebx,%edx,1),%ecx
80104603:	39 c8                	cmp    %ecx,%eax
80104605:	73 eb                	jae    801045f2 <argptr+0x42>
80104607:	eb dc                	jmp    801045e5 <argptr+0x35>
80104609:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    return -1;
80104610:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104615:	eb e2                	jmp    801045f9 <argptr+0x49>
...
80104649:	e8 d2 fe ff ff       	call   80104520 <fetchstr>
}
8010464e:	c9                   	leave  
8010464f:	c3                   	ret    
    return -1;
...
80104668:	e8 33 f0 ff ff       	call   801036a0 <myproc>
  ...
  num = curproc->tf->eax;
8010466d:	8b 70 1c             	mov    0x1c(%eax),%esi
  struct proc *curproc = myproc();
...
80104698:	89 44 24 0c          	mov    %eax,0xc(%esp)
            curproc->pid, curproc->name, num);
8010469c:	8d 43 70             	lea    0x70(%ebx),%eax
8010469f:	89 44 24 08          	mov    %eax,0x8(%esp)
    cprintf("%d %s: unknown sys call %d\n",
801046a3:	8b 43 14             	mov    0x14(%ebx),%eax
801046a6:	c7 04 24 c5 74 10 80 	movl   $0x801074c5,(%esp)
801046ad:	89 44 24 04          	mov    %eax,0x4(%esp)
801046b1:	e8 9a bf ff ff       	call   80100650 <cprintf>
    curproc->tf->eax = -1;
801046b6:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
801046e0:	8b 4c 90 2c          	mov    0x2c(%eax,%edx,4),%ecx
...
801046fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      curproc->ofile[fd] = f;
80104700:	89 5c 90 2c          	mov    %ebx,0x2c(%eax,%edx,4)
}
...
801048aa:	e8 d1 fc ff ff       	call   80104580 <argint>
...
801048c1:	8b 44 90 2c          	mov    0x2c(%eax,%edx,4),%eax
...
80104929:	e8 a2 c4 ff ff       	call   80100dd0 <filedup>
  return fd;
...
80104962:	e8 19 fc ff ff       	call   80104580 <argint>
...
8010499d:	e8 8e c5 ff ff       	call   80100f30 <fileread>
}
801049a2:	c9                   	leave  
801049a3:	c3                   	ret    
...
801049d2:	e8 a9 fb ff ff       	call   80104580 <argint>
...
80104a0d:	e8 be c5 ff ff       	call   80100fd0 <filewrite>
}
80104a12:	c9                   	leave  
80104a13:	c3                   	ret    
...
80104a3d:	c7 44 90 2c 00 00 00 	movl   $0x0,0x2c(%eax,%edx,4)
80104a44:	00 
  fileclose(f);
80104a45:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a48:	89 04 24             	mov    %eax,(%esp)
80104a4b:	e8 d0 c3 ff ff       	call   80100e20 <fileclose>
  return 0;
...
80104aa0:	e8 3b c4 ff ff       	call   80100ee0 <filestat>
}
80104aa5:	c9                   	leave  
80104aa6:	c3                   	ret    
80104aa7:	90                   	nop
...
80104c9e:	e8 ed f5 ff ff       	call   80104290 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80104df2:	e8 89 f7 ff ff       	call   80104580 <argint>
...
80104e36:	e8 25 bf ff ff       	call   80100d60 <filealloc>
...
80104eeb:	e8 30 bf ff ff       	call   80100e20 <fileclose>
...
80104f90:	e8 eb f5 ff ff       	call   80104580 <argint>
  if((argstr(0, &path)) < 0 ||
...
80104fa7:	e8 d4 f5 ff ff       	call   80104580 <argint>
     argint(1, &major) < 0 ||
...
8010503e:	e8 4d c7 ff ff       	call   80101790 <iunlock>
  iput(curproc->cwd);
80105043:	8b 46 6c             	mov    0x6c(%esi),%eax
...
80105053:	31 c0                	xor    %eax,%eax
  curproc->cwd = ip;
80105055:	89 5e 6c             	mov    %ebx,0x6c(%esi)
}
...
801050bb:	e8 c0 f4 ff ff       	call   80104580 <argint>
...
801050eb:	e8 a0 f1 ff ff       	call   80104290 <memset>
    if(i >= NELEM(argv))
      return -1;
...
80105100:	e8 db f3 ff ff       	call   801044e0 <fetchint>
...
8010511a:	e8 01 f4 ff ff       	call   80104520 <fetchstr>
...
801051e5:	c7 44 98 2c 00 00 00 	movl   $0x0,0x2c(%eax,%ebx,4)
801051ec:	00 
    fileclose(rf);
801051ed:	8b 45 f0             	mov    -0x10(%ebp),%eax
801051f0:	89 04 24             	mov    %eax,(%esp)
801051f3:	e8 28 bc ff ff       	call   80100e20 <fileclose>
    fileclose(wf);
801051f8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051fb:	89 04 24             	mov    %eax,(%esp)
801051fe:	e8 1d bc ff ff       	call   80100e20 <fileclose>
}
...
80105224:	e8 57 f3 ff ff       	call   80104580 <argint>
...
80105259:	e8 72 1b 00 00       	call   80106dd0 <shm_open>
}
8010525e:	c9                   	leave  
8010525f:	c3                   	ret    
    return -1;
...
80105284:	e8 f7 f2 ff ff       	call   80104580 <argint>
...
80105293:	e8 48 1b 00 00       	call   80106de0 <shm_close>
}
80105298:	c9                   	leave  
80105299:	c3                   	ret    
...
801052b3:	5d                   	pop    %ebp
  return fork();
801052b4:	e9 97 e5 ff ff       	jmp    80103850 <fork>
...
801052d3:	5d                   	pop    %ebp
  return wait();
801052d4:	e9 e7 e9 ff ff       	jmp    80103cc0 <wait>
...
801052f4:	e8 87 f2 ff ff       	call   80104580 <argint>
...
80105303:	e8 f8 ea ff ff       	call   80103e00 <kill>
}
80105308:	c9                   	leave  
80105309:	c3                   	ret    
...
80105323:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105326:	e8 75 e3 ff ff       	call   801036a0 <myproc>
8010532b:	8b 40 14             	mov    0x14(%eax),%eax
}
8010532e:	c9                   	leave  
8010532f:	c3                   	ret    
...
8010534c:	78 22                	js     80105370 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
8010534e:	e8 4d e3 ff ff       	call   801036a0 <myproc>
  if(growproc(n) < 0)
...
8010535b:	e8 80 e4 ff ff       	call   801037e0 <growproc>
...
801053cf:	e8 3c e8 ff ff       	call   80103c10 <sleep>
  while(ticks - ticks0 < n){
...
801053de:	73 28                	jae    80105408 <sys_sleep+0x88>
    if(myproc()->killed){
801053e0:	e8 bb e2 ff ff       	call   801036a0 <myproc>
801053e5:	8b 40 28             	mov    0x28(%eax),%eax
801053e8:	85 c0                	test   %eax,%eax
801053ea:	74 d4                	je     801053c0 <sys_sleep+0x40>
      release(&tickslock);
801053ec:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801053f3:	e8 48 ee ff ff       	call   80104240 <release>
      return -1;
...
8010540f:	e8 2c ee ff ff       	call   80104240 <release>
}
...
80105506:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
8010550c:	e8 4f eb ff ff       	call   80104060 <initlock>
}
80105511:	c9                   	leave  
80105512:	c3                   	ret    
...
80105578:	e8 23 e1 ff ff       	call   801036a0 <myproc>
...
8010559c:	e8 df e0 ff ff       	call   80103680 <cpuid>
...
801055ac:	e8 ef e0 ff ff       	call   801036a0 <myproc>
...
801055ce:	8b 55 e4             	mov    -0x1c(%ebp),%edx
            myproc()->pid, myproc()->name, tf->trapno,
801055d1:	83 c6 70             	add    $0x70,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
801055e0:	8b 40 14             	mov    0x14(%eax),%eax
...
801055ee:	e8 5d b0 ff ff       	call   80100650 <cprintf>
    ...
    myproc()->killed = 1;
801055f3:	e8 a8 e0 ff ff       	call   801036a0 <myproc>
801055f8:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
801055ff:	90                   	nop
  }
...
80105600:	e8 9b e0 ff ff       	call   801036a0 <myproc>
80105605:	85 c0                	test   %eax,%eax
80105607:	74 0c                	je     80105615 <trap+0xc5>
80105609:	e8 92 e0 ff ff       	call   801036a0 <myproc>
8010560e:	8b 50 28             	mov    0x28(%eax),%edx
...
80105615:	e8 86 e0 ff ff       	call   801036a0 <myproc>
...
80105629:	74 4d                	je     80105678 <trap+0x128>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010562b:	e8 70 e0 ff ff       	call   801036a0 <myproc>
...
801056d7:	e8 a4 df ff ff       	call   80103680 <cpuid>
...
8010573f:	5d                   	pop    %ebp
      exit();
80105740:	e9 6b e3 ff ff       	jmp    80103ab0 <exit>
80105745:	8d 76 00             	lea    0x0(%esi),%esi
      exit();
80105748:	e8 63 e3 ff ff       	call   80103ab0 <exit>
8010574d:	eb cd                	jmp    8010571c <trap+0x1cc>
8010574f:	90                   	nop
      acquire(&tickslock);
80105750:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105757:	e8 f4 e9 ff ff       	call   80104150 <acquire>
      wakeup(&ticks);
...
80105817:	e8 84 cf ff ff       	call   801027a0 <microdelay>
...
801058b4:	e8 f7 c9 ff ff       	call   801022b0 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
...
801063b4:	e8 e7 c0 ff ff       	call   801024a0 <kalloc>
...
801063d2:	e8 b9 de ff ff       	call   80104290 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106443:	e8 a8 be ff ff       	call   801022f0 <kfree>
      *pte = 0;
...
8010648a:	c3                   	ret    
        panic("kfree");
8010648b:	c7 04 24 66 70 10 80 	movl   $0x80107066,(%esp)
...
801064a3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801064a6:	e8 d5 d1 ff ff       	call   80103680 <cpuid>
...
8010660e:	0f 84 cd 00 00 00    	je     801066e1 <switchuvm+0xe1>
  if(p->kstack == 0)
80106614:	8b 46 0c             	mov    0xc(%esi),%eax
80106617:	85 c0                	test   %eax,%eax
80106619:	0f 84 da 00 00 00    	je     801066f9 <switchuvm+0xf9>
  if(p->pgdir == 0)
8010661f:	8b 7e 08             	mov    0x8(%esi),%edi
80106622:	85 ff                	test   %edi,%edi
80106624:	0f 84 c3 00 00 00    	je     801066ed <switchuvm+0xed>
  pushcli();
8010662a:	e8 e1 da ff ff       	call   80104110 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010662f:	e8 cc cf ff ff       	call   80103600 <mycpu>
80106634:	89 c3                	mov    %eax,%ebx
80106636:	e8 c5 cf ff ff       	call   80103600 <mycpu>
8010663b:	89 c7                	mov    %eax,%edi
8010663d:	e8 be cf ff ff       	call   80103600 <mycpu>
80106642:	83 c7 08             	add    $0x8,%edi
80106645:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106648:	e8 b3 cf ff ff       	call   80103600 <mycpu>
...
801066db:	5d                   	pop    %ebp
  popcli();
801066dc:	e9 ef da ff ff       	jmp    801041d0 <popcli>
...
8010672a:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  mem = kalloc();
8010672d:	e8 6e bd ff ff       	call   801024a0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106745:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80106747:	e8 44 db ff ff       	call   80104290 <memset>
...
80106788:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106789:	e9 a2 db ff ff       	jmp    80104330 <memmove>
...
80106872:	0f 87 98 00 00 00    	ja     80106910 <allocuvm+0xb0>
  if(newsz < oldsz)
80106878:	3b 7d 0c             	cmp    0xc(%ebp),%edi
    return oldsz;
8010687b:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
8010687e:	0f 82 8e 00 00 00    	jb     80106912 <allocuvm+0xb2>
  a = PGROUNDUP(oldsz);
80106884:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
8010688a:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
80106890:	39 df                	cmp    %ebx,%edi
80106892:	77 5b                	ja     801068ef <allocuvm+0x8f>
80106894:	e9 87 00 00 00       	jmp    80106920 <allocuvm+0xc0>
80106899:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    memset(mem, 0, PGSIZE);
801068a0:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801068a7:	00 
801068a8:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801068af:	00 
801068b0:	89 04 24             	mov    %eax,(%esp)
801068b3:	e8 d8 d9 ff ff       	call   80104290 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
801068b8:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
801068be:	89 44 24 0c          	mov    %eax,0xc(%esp)
801068c2:	8b 45 08             	mov    0x8(%ebp),%eax
801068c5:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801068cc:	00 
801068cd:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801068d4:	00 
801068d5:	89 5c 24 04          	mov    %ebx,0x4(%esp)
801068d9:	89 04 24             	mov    %eax,(%esp)
801068dc:	e8 7f fc ff ff       	call   80106560 <mappages>
801068e1:	85 c0                	test   %eax,%eax
801068e3:	78 4b                	js     80106930 <allocuvm+0xd0>
  for(; a < newsz; a += PGSIZE){
801068e5:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801068eb:	39 df                	cmp    %ebx,%edi
801068ed:	76 31                	jbe    80106920 <allocuvm+0xc0>
    mem = kalloc();
801068ef:	e8 ac bb ff ff       	call   801024a0 <kalloc>
    if(mem == 0){
801068f4:	85 c0                	test   %eax,%eax
    mem = kalloc();
801068f6:	89 c6                	mov    %eax,%esi
    if(mem == 0){
801068f8:	75 a6                	jne    801068a0 <allocuvm+0x40>
      cprintf("allocuvm out of memory\n");
801068fa:	c7 04 24 6d 77 10 80 	movl   $0x8010776d,(%esp)
80106901:	e8 4a 9d ff ff       	call   80100650 <cprintf>
  if(newsz >= oldsz)
80106906:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106909:	77 55                	ja     80106960 <allocuvm+0x100>
8010690b:	90                   	nop
8010690c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      return 0;
80106910:	31 c0                	xor    %eax,%eax
}
80106912:	83 c4 2c             	add    $0x2c,%esp
80106915:	5b                   	pop    %ebx
80106916:	5e                   	pop    %esi
80106917:	5f                   	pop    %edi
80106918:	5d                   	pop    %ebp
...
8010695e:	5d                   	pop    %ebp
8010695f:	c3                   	ret    
80106960:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106963:	89 fa                	mov    %edi,%edx
80106965:	8b 45 08             	mov    0x8(%ebp),%eax
80106968:	e8 93 fa ff ff       	call   80106400 <deallocuvm.part.0>
      return 0;
8010696d:	31 c0                	xor    %eax,%eax
8010696f:	eb a1                	jmp    80106912 <allocuvm+0xb2>
80106971:	eb 0d                	jmp    80106980 <deallocuvm>
80106973:	90                   	nop
80106974:	90                   	nop
80106975:	90                   	nop
80106976:	90                   	nop
...
80106990:	5d                   	pop    %ebp
80106991:	e9 6a fa ff ff       	jmp    80106400 <deallocuvm.part.0>
...
801069ba:	e8 41 fa ff ff       	call   80106400 <deallocuvm.part.0>
...
80106a03:	e9 e8 b8 ff ff       	jmp    801022f0 <kfree>
    panic("freevm: no pgdir");
80106a08:	c7 04 24 a1 77 10 80 	movl   $0x801077a1,(%esp)
...
80106a4b:	e8 40 d8 ff ff       	call   80104290 <memset>
...
80106a70:	e8 eb fa ff ff       	call   80106560 <mappages>
...
80106ade:	e8 8d f8 ff ff       	call   80106370 <walkpgdir>
  if(pte == 0)
...
80106aeb:	c3                   	ret    
    panic("clearpteu");
80106aec:	c7 04 24 b2 77 10 80 	movl   $0x801077b2,(%esp)
...
80106b13:	0f 84 5d 01 00 00    	je     80106c76 <copyuvm+0x176>
    return 0;
...
80106b3d:	e8 ee d7 ff ff       	call   80104330 <memmove>
...
80106b65:	e8 f6 f9 ff ff       	call   80106560 <mappages>
...
80106b80:	e8 eb f7 ff ff       	call   80106370 <walkpgdir>
80106b85:	85 c0                	test   %eax,%eax
80106b87:	0f 84 fc 00 00 00    	je     80106c89 <copyuvm+0x189>
    if(!(*pte & PTE_P))
80106b8d:	8b 30                	mov    (%eax),%esi
80106b8f:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106b95:	0f 84 e2 00 00 00    	je     80106c7d <copyuvm+0x17d>
    pa = PTE_ADDR(*pte);
...
80106ba6:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106bac:	e8 ef b8 ff ff       	call   801024a0 <kalloc>
...
80106bd5:	eb 55                	jmp    80106c2c <copyuvm+0x12c>
80106bd7:	90                   	nop
    memmove(mem, (char*)P2V(pa), PGSIZE);
...
80106bed:	e8 3e d7 ff ff       	call   80104330 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
...
80106c15:	e8 46 f9 ff ff       	call   80106560 <mappages>
80106c1a:	85 c0                	test   %eax,%eax
80106c1c:	78 9d                	js     80106bbb <copyuvm+0xbb>
  for(i = KERNBASE - 2*PGSIZE; i < KERNBASE; i += PGSIZE){
80106c1e:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106c24:	81 fb 00 00 00 80    	cmp    $0x80000000,%ebx
80106c2a:	74 3f                	je     80106c6b <copyuvm+0x16b>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106c2c:	8b 45 08             	mov    0x8(%ebp),%eax
80106c2f:	31 c9                	xor    %ecx,%ecx
80106c31:	89 da                	mov    %ebx,%edx
80106c33:	e8 38 f7 ff ff       	call   80106370 <walkpgdir>
80106c38:	85 c0                	test   %eax,%eax
80106c3a:	74 4d                	je     80106c89 <copyuvm+0x189>
    if(!(*pte & PTE_P))
80106c3c:	8b 30                	mov    (%eax),%esi
80106c3e:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106c44:	74 37                	je     80106c7d <copyuvm+0x17d>
    pa = PTE_ADDR(*pte);
80106c46:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106c48:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106c4e:	89 75 e4             	mov    %esi,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106c51:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106c57:	e8 44 b8 ff ff       	call   801024a0 <kalloc>
80106c5c:	85 c0                	test   %eax,%eax
80106c5e:	89 c6                	mov    %eax,%esi
80106c60:	0f 85 72 ff ff ff    	jne    80106bd8 <copyuvm+0xd8>
80106c66:	e9 50 ff ff ff       	jmp    80106bbb <copyuvm+0xbb>
...
80106c78:	e9 4b ff ff ff       	jmp    80106bc8 <copyuvm+0xc8>
      panic("copyuvm: page not present");
80106c7d:	c7 04 24 d6 77 10 80 	movl   $0x801077d6,(%esp)
80106c84:	e8 d7 96 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106c89:	c7 04 24 bc 77 10 80 	movl   $0x801077bc,(%esp)
80106c90:	e8 cb 96 ff ff       	call   80100360 <panic>
80106c95:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
...
80106cae:	e8 bd f6 ff ff       	call   80106370 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106d1c:	e8 0f d6 ff ff       	call   80104330 <memmove>
    len -= n;
    buf += n;
...
80106d76:	c7 44 24 04 14 78 10 	movl   $0x80107814,0x4(%esp)
80106d7d:	80 
80106d7e:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106d85:	e8 d6 d2 ff ff       	call   80104060 <initlock>
  acquire(&(shm_table.lock));
80106d8a:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106d91:	e8 ba d3 ff ff       	call   80104150 <acquire>
...
80106dc5:	e8 76 d4 ff ff       	call   80104240 <release>
}
80106dca:	c9                   	leave  
80106dcb:	c3                   	ret    
